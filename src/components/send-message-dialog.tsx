          ...
          <div className="flex items-center gap-3 rounded-lg border bg-muted/50 p-3">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-2">
                ...
                {customer.isPremium && <Badge variant="default" className="text-xs">Premium</Badge>}
              </div>
            </div>
          </div>
        )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Maximum 4096 characters. The message will be sent directly to the customer's Telegram chat.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      placeholder="https://your-mini-app.com"
                      {...field}
                    />
                  </FormControl>
                  <FormDescription>
                    If provided, an "Open Mini App" button will be added to the message.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
