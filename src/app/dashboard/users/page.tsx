        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground">{total === 0 ? 'No customers found.' : `${total} customer${total !== 1 ? 's' : ''} found`}</p>
            </div>
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              <DropdownMenuItem asChild>
                <Link href={`/dashboard/users/${customer.id}`}>View Details</Link>
              </DropdownMenuItem>
  ...
  return (
    <div className="flex min-h-[400px] flex-col items-center justify-center rounded-lg border border-dashed">
      <div className="mx-auto flex max-w-[420px] flex-col items-center justify-center text-center">
        ...
        <p className="mb-4 mt-2 text-sm text-muted-foreground">You don't have any customers yet. Once users start interacting with your Telegram bots, they'll appear here.</p>
